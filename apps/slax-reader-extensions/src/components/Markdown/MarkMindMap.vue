...
const toolbarIcons = computed<ToolbarIcon[]>(() => {
  ...
  const icons: ToolbarIcon[] = [
    {
      id: 'scale-up',
      svg: '<svg width="100%" height="100%" viewBox="0 0 48 48" fill="none"><path d="M21 38C30.3888 38 38 30.3888 38 21C38 11.6112 30.3888 4 21 4C11.6112 4 4 11.6112 4 21C4 30.3888 11.6112 38 21 38Z" fill="none" stroke="#ffffffe6" stroke-width="4" stroke-linejoin="round"/><path d="M21 15L21 27" stroke="#ffffffe6" stroke-width="4" stroke-linecap="round" stroke-linejoin="round"/><path d="M15.0156 21.0156L27 21" stroke="#ffffffe6" stroke-width="4" stroke-linecap="round" stroke-linejoin="round"/><path d="M33.2216 33.2217L41.7069 41.707" stroke="#ffffffe6" stroke-width="4" stroke-linecap="round" stroke-linejoin="round"/></svg>'
    },
    {
      id: 'scale-down',
  ...
  if (fullScreenAvailable) {
    icons.push(
      !isFullscreen.value
        ? {
            id: 'fullscreen',
            svg: '<svg width="100%" height="100%" viewBox="0 0 48 48" fill="none"><path d="M33 6H42V15" stroke="#ffffffe6" stroke-width="4" stroke-linecap="round" stroke-linejoin="round"/><path d="M42 33V42H33" stroke="#ffffffe6" stroke-width="4" stroke-linecap="round" stroke-linejoin="round"/><path d="M15 42H6V33" stroke="#ffffffe6" stroke-width="4" stroke-linecap="round" stroke-linejoin="round"/><path d="M6 15V6H15" stroke="#ffffffe6" stroke-width="4" stroke-linecap="round" stroke-linejoin="round"/></svg>'
          }
        : {
            id: 'fullscreen-exit',
            svg: '<svg width="100%" height="100%" viewBox="0 0 48 48" fill="none"><path d="M33 6V15H42" stroke="#ffffffe6" stroke-width="4" stroke-linecap="round" stroke-linejoin="round"/><path d="M15 6V15H6" stroke="#ffffffe6" stroke-width="4" stroke-linecap="round" stroke-linejoin="round"/><path d="M15 42V33H6" stroke="#ffffffe6" stroke-width="4" stroke-linecap="round" stroke-linejoin="round"/><path d="M33 42V33H41.8995" stroke="#ffffffe6" stroke-width="4" stroke-linecap="round" stroke-linejoin="round"/></svg>'
          }
    )
  }
  ...
  icons.push({
    id: 'download',
    svg: '<svg width="100%" height="100%" viewBox="0 0 48 48" fill="none"><path d="M6 24.0083V42H42V24" stroke="#ffffffe6" stroke-width="4" stroke-linecap="round" stroke-linejoin="round"/><path d="M33 23L24 32L15 23" stroke="#ffffffe6" stroke-width="4" stroke-linecap="round" stroke-linejoin="round"/><path d="M23.9917 6V32" stroke="#ffffffe6" stroke-width="4" stroke-linecap="round" stroke-linejoin="round"/></svg>'
  })
...
.mark-mind-map {
  ...
  .mind-toolbar {
    ...
    .item {
      ...
      .icon-bg {
        --style: absolute top-0 left-0 bg-#FFFFFF33 filter-blur-10 w-full h-full;
      }

          ...
          <article class="download-card">
            <div class="card-content">
              ...
              <div class="download-buttons">
                <a
                  href="https://apps.apple.com/cn/app/slax-reader-ai-read-it-later/id6596730998"
                  target="_blank"
                ...
                <a
                  href="https://play.google.com/store/apps/details?id=com.slax.reader"
                  target="_blank"
                  rel="noopener noreferrer"
            ...
            <div class="card-content">
              ...
              <div class="download-buttons">
                <a
                  ...
                  @click="handleDownload('browser_extension')"
                >
...
const handleDownload = (client: 'ios' | 'android' | 'mac' | 'browser_extension') => {
  analyticsLog({

...
.question-message {
  --style: 'relative w-398px min-h-48px rounded-8px border-(1px solid) py-13px pl-16px pr-19px flex items-center justify-between select-none bg-#fff border-#99999933 dark:(bg-#1F1F1FFF border-#ffffff0a)';
  ...
  .text {
    --style: 'text-(15px) line-height-22px font-500 text-#333 dark:text-#ffffffcc';

    &:deep(*) {
      --style: 'text-(15px) line-height-22px font-500 list-none text-#333 dark:text-#ffffffcc';
    }
  }
